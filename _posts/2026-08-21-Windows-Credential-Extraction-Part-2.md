...
> Nối tiếp [Part 1](/) (bootkey → SAM key → NT hash local, LSA key → LSA
> secret → DCC2) — phần này trả lời: credential của **toàn domain** nằm ở
> đâu, mã hoá mấy lớp, và muốn đọc thì cần những gì.
